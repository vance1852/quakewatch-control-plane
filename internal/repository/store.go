...
type IdempotencyAbort struct {
	RecordID string
	Cause    error
}

func (a IdempotencyAbort) Error() string {
	return fmt.Sprintf("abort idempotency reservation %s: %v", a.RecordID, a.Cause)
}

func (a IdempotencyAbort) Unwrap() error { return a.Cause }
